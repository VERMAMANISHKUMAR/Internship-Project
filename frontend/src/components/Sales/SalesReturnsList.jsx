...
<header className="p-4 rounded-lg flex flex-col md:flex-row justify-between items-center mb-6 bg-gray-100">
                <h1 className="text-2xl font-semibold">Sales Returns List<span className="text-sm/6 text-gray-500">View/Search Sold Items</span></h1>
                <div className="flex items-center space-x-2 text-blue-600">
                    ...
                    <Link to="/brands" className=" text-gray-500 hover:text-cyan-600 no-underline text-sm/6">Sales Returns List</Link>
                </div>
</header>  
...
<div className="grid grid-cols-2 gap-4">
  ...
  <div className="flex items-center bg-white text-black rounded-lg shadow-md">
    ...
    <div className="flex flex-col justify-center ml-4">
    <h2 className="text-xl">₹0</h2>
    <p className='font-bold'>Total Returned Amount</p>
    </div>
  </div>
  ...
  <CashIcon className="text-white bg-cyan-500 rounded w-18 h-16" />
    <div className="flex flex-col justify-center ml-4">
    <h2 className="text-xl">₹0</h2>
    <p className='font-bold'>Total Sales Return Due</p>
    </div>
  </div>
</div>
</div>
...
<div className="flex flex-col md:flex-row items-center gap-4 md:gap-28 mt-3 w-full justify-between">
  ...
  <button className="w-full md:w-auto px-2 py-2 bg-cyan-300 text-white rounded-md hover:bg-cyan-500 transition">
    <span className='font- text-xl'>+ </span>Create Purchase
  </button>
</div>
{/* ------------------------------------------------------------------ */}
      ...
      <div className="overflow-x-auto mt-6">
        <table className="min-w-full bg-white border border-gray-300 shadow-sm">
          <thead className="bg-gray-200">
            <tr>
              {[
                'Return Date', 'Sales Code', 'Return Status', 'Reference No.',
