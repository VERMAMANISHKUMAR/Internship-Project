...
<header className="p-4 rounded-lg flex flex-col md:flex-row justify-between items-center mb-6 bg-gray-100">
                <h1 className="text-2xl font-semibold">Purchase Returns List <span className="text-sm/6 text-gray-500">View/Search Purchase</span></h1>
                <div className="flex items-center space-x-2 text-blue-600">
                    ...
                    <Link to="/brands" className=" text-gray-500 hover:text-cyan-600 no-underline text-sm/6">Purchase Returns List</Link>
                </div>
</header>  
